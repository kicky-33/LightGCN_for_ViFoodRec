...
│   ├── model.py                        # BPRMF, NGCF, LightGCN (cài đặt lại, dùng cho train.py)
│   ├── losses.py                       # BPR loss
...
### Train LightGCN (1 model, CLI)
```bash
python scripts/train_lightgcn_pyg.py --seed 2026 --data-dir data/processed/experiments/th3_5
# hoặc: python scripts/train.py --model lightgcn --threshold 3.5 --seed 2026
```
